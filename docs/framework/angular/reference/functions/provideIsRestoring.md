...
Defined in: [packages/angular-query/src/inject-is-restoring.ts:31](https://github.com/TanStack/query/blob/main/packages/angular-query/src/inject-is-restoring.ts#L31)
